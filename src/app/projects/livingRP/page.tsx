    ...
    <>
      ...
      <section className="grid grid-cols-4 gap-2 md:gap-4 md:w-1/2 w-4/5 mx-auto justify-center mt-8 md:mb-28 mb-20">
        ...
        <img
          ...
          className="row-span-2 row-start-1 col-start-3 col-span-2 md:h-full h-[272px]"
          alt=""
        />
        <img src={Foto3.src} className="col-span-4 md:h-64 h-40 w-full" alt="" />
        <img src={Foto4.src} className="col-span-2 md:h-auto h-[132px]" alt="" />
        <img src={Foto5.src} className="col-span-2 md:h-auto h-[132px]" alt="" />
      </section>
      <Footer />
    </>
  );
